 ...
 * @date: 2016-08-29
 */
@RequiresPresenter(CreditLawsListPresenter.class)
public class CreditLawsListActivity extends BeamListActivity<CreditLawsListPresenter, Map> {
    ...
    public BaseViewHolder<Map> getViewHolder(ViewGroup parent, int viewType) {
        return new CreditLawsVHodler(parent);
    }
