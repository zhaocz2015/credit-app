 ...
 * @date: 2016-08-29
 */
@RequiresPresenter(CreditExpoListPresenter.class)
public class CreditExpoListActivity extends BeamListActivity<CreditExpoListPresenter, Map> {
    ...
    public BaseViewHolder<Map> getViewHolder(ViewGroup parent, int viewType) {
        return new CreditExpoVHodler(parent);
    }
